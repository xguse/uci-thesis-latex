...
%
Htwo ortholog-sets produced errors during the process that parsed the \gls{Argot2} results and others returned no process or function domain terms.
...
%
Using OrthoDB to examine annotation terms assigned to these ortholog-sets with the OrthoDB ``metazoa'' ortholog database yielded notable results.
%
