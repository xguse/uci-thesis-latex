...
Cluster 4 is characterized by genes that have a median \gls{NBF} \gls{FPKM} of approximately 1.5 standard deviations below their mean and media\gls{FPKM} values between 0 and 0.5 standard deviations above their mean for the remainder of the time course (Figures \ref{fig:23-clusters} and \ref{fig:cluster4}).
%
